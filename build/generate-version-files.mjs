...
const template = {
  ...
  githubUrl: `https://github.com/ThinkInAIXYZ/doesaiagent/releases/tag/v${params.version}`,
  downloadUrl: `https://doesaiagent.thinkinai.xyz/#/download`
}
...
platforms.forEach((platform) => {
  ...
  // Start of Selection
  if (os === 'windows') {
    platformData.githubUrl = `https://github.com/ThinkInAIXYZ/doesaiagent/releases/download/v${params.version}/DoesAIAgent-${params.version}-windows-${arch}.exe`
  } else if (os === 'mac') {
    platformData.githubUrl = `https://github.com/ThinkInAIXYZ/doesaiagent/releases/download/v${params.version}/DoesAIAgent-${params.version}-mac-${arch}.dmg`
  } else if (os === 'linux') {
    platformData.githubUrl = `https://github.com/ThinkInAIXYZ/doesaiagent/releases/download/v${params.version}/DoesAIAgent-${params.version}-linux-${arch}.tar.gz`
  }
  // 写入文件
