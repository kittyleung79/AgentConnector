...
# DoesAIAgent Tool Use 技术文档

## 背景与目标

随着 LLM (大模型) 支持 Function Calling 能力的增强，DoesAIAgent 通过**提示词工程（prompt engineering）**，即使在不依赖原生 function calling 的情况下，也能**模拟 Tool Use 行为**。
