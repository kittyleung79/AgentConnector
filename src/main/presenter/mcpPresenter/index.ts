...
export class McpPresenter implements IMCPPresenter {
  ...
  constructor(configPresenter?: IConfigPresenter) {
    ...
    this.restServer = new RestServer(this.configPresenter, this.serverManager)
    this.sseServer = new SseServer(this.configPresenter, this.serverManager)
  ...
  private async initialize() {
    try {
      ...
      // 检查并启动 doesaiagent-inmemory/custom-prompts-server
      const customPromptsServerName = 'doesaiagent-inmemory/custom-prompts-server'
