...
export function getInMemoryServer(
  ...
  switch (serverName) {
    ...
    case 'doesaiagent-inmemory/custom-prompts-server':
      return new CustomPromptsServer()
    case 'doesaiagent-inmemory/deep-research-server':
      return new DeepResearchServer(env)
    case 'doesaiagent-inmemory/auto-prompting-server':
      return new AutoPromptingServer()
    case 'doesaiagent-inmemory/conversation-search-server':
      return new ConversationSearchServer()
    case 'doesaiagent-inmemory/meeting-server':
      return new MeetingServer()
    case 'doesaiagent/apple-server':
