...
${ARTIFACT_INSTRUCTIONS_HEAD}
    - HTML: "text/html"
      ...
      - do not forget to add AI information in the footer: "Generated with [DoesAIAgent](https://github.com/ThinkInAIXYZ/doesaiagent) | All page content is AI-generated and for reference only" ,ensure it matches the page language
${ARTIFACT_INSTRUCTIONS_TAIL}
<example>
...
<body>
    ...
    <footer>
      Generated with <a href="https://github.com/ThinkInAIXYZ/doesaiagent">DoesAIAgent</a> | All page content is AI-generated and for reference only
    </footer>
</body>
</html>
    </antArtifact>
...
export class ArtifactsServer {
  ...
  constructor() {
    ...
    this.server = new Server(
      {
        name: 'doesaiagent-inmemory/artifacts-server',
        version: '1.0.0'
      },
      {
        capabilities: {
