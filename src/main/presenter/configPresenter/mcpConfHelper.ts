...
const PLATFORM_SPECIFIC_SERVERS: Record<string, MCPServerConfig> = {
  ...
  // ...(isMacOS()
  //   ? {
  //       'DoesAI Agent/apple-server': {
  //         args: [],
  //         descriptions: 'DoesAI内置Apple系统集成服务 (仅macOS)',
  //         icons: '🍎',
  //         autoApprove: ['all'],
  //         type: 'inmemory' as MCPServerType,
  //         command: 'DoesAIAgent/apple-server',
  //         env: {},
  //         disable: false
  //       }
  //     }
...
const DEFAULT_INMEMORY_SERVERS: Record<string, MCPServerConfig> = {
  buildInFileSystem: {
    ...
    descriptions: 'AgentConnector内置文件系统mcp服务',
    icons: '📁',
    autoApprove: ['read'],
    type: 'inmemory' as MCPServerType,
    command: 'filesystem',
  ...
  Artifacts: {
    args: [],
    descriptions: 'AgentConnector内置 artifacts mcp服务',
    icons: '🎨',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
    command: 'artifacts',
  ...
  bochaSearch: {
    args: [],
    descriptions: 'AgentConnector内置博查搜索服务',
    icons: '🔍',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
    command: 'bochaSearch',
  ...
  braveSearch: {
    args: [],
    descriptions: 'AgentConnector内置Brave搜索服务',
    icons: '🦁',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
    command: 'braveSearch',
  ...
  difyKnowledge: {
    args: [],
    descriptions: 'AgentConnector内置Dify知识库检索服务',
    icons: '📚',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  powerpack: {
    args: [],
    descriptions: 'AgentConnector内置增强工具包',
    icons: '🛠️',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
    command: 'powerpack',
  ...
  ragflowKnowledge: {
    args: [],
    descriptions: 'AgentConnector内置RAGFlow知识库检索服务',
    icons: '📚',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  fastGptKnowledge: {
    args: [],
    descriptions: 'AgentConnector内置FastGPT知识库检索服务',
    icons: '📚',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  builtinKnowledge: {
    args: [],
    descriptions: 'AgentConnector内置知识库检索服务',
    icons: '📚',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
  ...
  AgentDNS: {
    args: [],
    descriptions: 'AgentDNS是一款多功能的智能体网络中的组件，它的主要功能是提供智能体注册，分类，统计分析服务，发现服务等，正在不断完善。',
    icons: '🛠️',
    autoApprove: ['all'],
    type: 'sse',
    command: '',
...
export const SYSTEM_INMEM_MCP_SERVERS: Record<string, MCPServerConfig> = {
  'AgentConnector-inmemory/custom-prompts-server': {
    command: 'deepchat-inmemory/custom-prompts-server',
    args: [],
    env: {},
    descriptions: 'AgentConnector内置自定义提示词服务',
    icons: '📝',
    autoApprove: ['all'],
    type: 'inmemory' as MCPServerType,
    disable: false
