...
declare module 'vue-i18n' {
  interface DefineLocaleMessage {
    ...
    inmemory: {
      ...
      'doesaiagent-inmemory/custom-prompts-server': {
        name: string
        desc: string
      }
      'doesaiagent-inmemory/deep-research-server': {
        name: string
        desc: string
      }
      'doesaiagent-inmemory/auto-prompting-server': {
        name: string
        desc: string
      }
      'doesaiagent-inmemory/conversation-search-server': {
        name: string
        desc: string
      }
      'doesaiagent-inmemory/meeting-server': {
        name: string
        desc: string
      }
      'doesaiagent/apple-server': {
        name: string
        desc: string
      }
    }
